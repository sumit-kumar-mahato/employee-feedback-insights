...
import faiss
import json
import google.generativeai as genai  # ✅ official Google SDK, works on Streamlit Cloud
...
if uploaded:
    ...
    st.success(f"📌 Created **{len(df_chunks)} chunks** from {len(df)} feedback entries.")
